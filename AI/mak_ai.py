#!/usr/bin/env python3
# =============================================================================
#  mak_ai — módulo do agente do Mak OS (Ollama)
#
#  Funcionalidades:
...
MODEL = os.environ.get("MAK_AI_MODEL", "llama3.1")

# Comandos autorizados para a automação (sandbox local)
ALLOWED_BINARIES = {
    "mak-finder", "mak-terminal", "mak-settings", "mak-calculator",
    "mak-monitor", "mak-notes", "mak-photos", "mak-music", "mak-browser",
    "mak-store", "xdg-open", "notify-send",
}

KNOWN_APPS = {
    "finder": "mak-finder", "arquivos": "mak-finder", "files": "mak-finder",
    "terminal": "mak-terminal", "settings": "mak-settings", "configurações": "mak-settings",
    "calculadora": "mak-calculator", "calc": "mak-calculator",
    "monitor": "mak-monitor", "notes": "mak-notes", "notas": "mak-notes",
    "fotos": "mak-photos", "photos": "mak-photos",
    "música": "mak-music", "music": "mak-music",
    "navegador": "mak-browser", "browser": "mak-browser", "store": "mak-store",
}
...
class Agent:
    """Agente do Mak OS: interpreta comandos e executa ações locais."""
    ...
    def summarize_file(self, path: str) -> str:
        ...
        reply = self.client.chat([
            {"role": "system", "content": "Você é o assistente do Mak OS. Resuma o texto em português, em até 120 palavras."},
    ...
    def handle(self, text: str) -> str:
        ...
        if not action:
            ...
            reply = self.client.chat([
                {"role": "system", "content": (
                    "Você é o Mak AI, assistente do sistema operacional Mak OS. "
