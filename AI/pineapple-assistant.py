#!/usr/bin/env python3
# =============================================================================
#  Pineapple Assistant — interface do assistente local (Ollama)
# =============================================================================
import sys
import threading
...
APP_ID = "org.pineappleos.assistant"


class PineappleAssistant(Gtk.Application):
    def __init__(self):
...
class AssistantWindow(Gtk.ApplicationWindow):
    def __init__(self, **kw):
        super().__init__(**kw)
        self.set_title("Pineapple Assistant")
        self.set_default_size(760, 560)
        self.set_css_classes(["pineapple-assistant-window"])
        ...
        self.view.set_css_classes(["pineapple-chat-view"])
        ...
        self.entry.set_css_classes(["pineapple-chat-input"])
        ...
        header = Gtk.Label(label="Pineapple Assistant  —  assistente local (Ollama)")
        header.set_css_classes(["pineapple-assistant-header"])
        ...
        self._append("sistema", "Olá! Sou o assistente do Pineapple OS. Posso abrir apps, "
    ...
    def _append(self, who, text):
        ...
        self.buffer.insert_with_tags(end, {"sistema": "Pineapple", "user": "Você", "assistente": "Pineapple"}[who] + ": ", tag)
        end = self.buffer.get_end_iter()
