#!/usr/bin/env python3
# =============================================================================
#  Pineapple Browser — navegador leve (WebKitGTK)
# =============================================================================
import gi
...
APP_ID = "org.pineappleos.browser"
HOMEPAGE = "https://duckduckgo.com"


class PineappleBrowser(Gtk.Application):
    def __init__(self):
...
class BrowserWindow(Gtk.ApplicationWindow):
    def __init__(self, **kw):
        super().__init__(**kw)
        self.set_title("Pineapple Browser")
    ...
    def _on_load(self, _web, event):
        if event == WebKit.LoadEvent.COMMITTED:
            ...
            self.set_title(self.web.get_title() or "Pineapple Browser")
    ...
    def _on_create(self, _web, action):
        ...
        window.set_title("Pineapple Browser")
