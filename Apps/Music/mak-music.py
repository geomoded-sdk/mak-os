#!/usr/bin/env python3
# =============================================================================
#  Mak Music — player de música simples (GLib playbin)
# =============================================================================
import os
...
APP_ID = "org.makos.music"
AUDIO_EXTS = (".mp3", ".ogg", ".flac", ".wav", ".m4a", ".opus")


class MakMusic(Gtk.Application):
    def __init__(self):
...
class MusicWindow(Gtk.ApplicationWindow):
    def __init__(self, **kw):
        ...
        self.title_label.add_css_class("mak-path")
    ...
    def _play(self):
        ...
        self.set_title(f"Mak Music — {self._playlist[self._index]}")
