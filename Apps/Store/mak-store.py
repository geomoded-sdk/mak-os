#!/usr/bin/env python3
# =============================================================================
#  Mak Store — loja de aplicativos (Flatpak) com categorias e repositório próprio
# =============================================================================
import subprocess
...
from mak_store_categories import CATEGORIES, category_for  # noqa: E402

APP_ID = "org.makos.store"
FLATHUB = "https://dl.flathub.org/repo/flathub.flatpakrepo"


class MakStore(Gtk.Application):
    def __init__(self):
...
class StoreWindow(Gtk.ApplicationWindow):
    def __init__(self, **kw):
        ...
        title = Gtk.Label(label="Mak Store", xalign=0.0)
        ...
        self.cat_list.set_css_classes(["mak-sidebar"])
    ...
    def _fallback_apps(self):
        return [
            {"name": "Mak Calculator", "id": "org.makos.calculator", "desc": "Calculadora nativa", "cat": "nativos", "installed": True},
            {"name": "Mak Terminal", "id": "org.makos.terminal", "desc": "Terminal nativo", "cat": "nativos", "installed": True},
            {"name": "Mak Notes", "id": "org.makos.notes", "desc": "Notas", "cat": "nativos", "installed": True},
            {"name": "Mak Photos", "id": "org.makos.photos", "desc": "Fotos", "cat": "nativos", "installed": True},
            {"name": "Mak Music", "id": "org.makos.music", "desc": "Música", "cat": "nativos", "installed": True},
            {"name": "Mak Browser", "id": "org.makos.browser", "desc": "Navegador", "cat": "nativos", "installed": True},
            {"name": "Mak Monitor", "id": "org.makos.monitor", "desc": "Monitor de recursos", "cat": "nativos", "installed": True},
    ...
    def _app_card(self, app):
        ...
        box.add_css_class("mak-store-card")
        ...
        name.add_css_class("mak-store-name")
        box.append(name)

        desc = Gtk.Label(label=app.get("desc", "")[:80], xalign=0.0, wrap=True)
        desc.add_css_class("mak-store-desc")
