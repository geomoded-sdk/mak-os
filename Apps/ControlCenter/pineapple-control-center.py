#!/usr/bin/env python3
# =============================================================================
#  Pineapple Control Center — central de controle do Pineapple OS
...
APP_ID = "org.pineappleos.controlcenter"


class PineappleControlCenter(Gtk.Application):
    def __init__(self):
...
class ControlCenterWindow(Gtk.ApplicationWindow):
    def __init__(self, **kw):
        ...
        self.add_css_class("pineapple-control-window")
        ...
        root.set_css_classes(["pineapple-control-panel"])

        title = Gtk.Label(label="Central de Controle", xalign=0.0)
        title.add_css_class("pineapple-control-title")
        root.append(title)
        ...
        settings.connect("clicked", lambda *_: subprocess.Popen(["pineapple-settings"]))
    ...
    def _toggle(self, label, cb, active):
        ...
        box.set_css_classes(["pineapple-control-toggle"])
...
if __name__ == "__main__":
    PineappleControlCenter().run(None)
