#!/usr/bin/env python3
# =============================================================================
#  Mak Terminal — terminal nativo do Mak OS (VTE + GTK4) com multi-abas
# =============================================================================
import gi
...
APP_ID = "org.makos.terminal"


class MakTerminal(Gtk.Application):
    def __init__(self):
