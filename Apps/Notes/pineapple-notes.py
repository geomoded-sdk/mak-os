#!/usr/bin/env python3
# =============================================================================
#  Pineapple Notes — notas com armazenamento local (JSON) e pesquisa
# =============================================================================
import json
import os
import uuid
...
APP_ID = "org.pineappleos.notes"
DATA_DIR = os.path.join(os.path.expanduser("~"), ".local", "share", "pineappleos", "notes")
HAS_FILE_DIALOG = hasattr(Gtk, "FileDialog")  # GTK >= 4.10


class PineappleNotes(Gtk.Application):
    def __init__(self):
...
class NotesWindow(Gtk.ApplicationWindow):
    def __init__(self, **kw):
        super().__init__(**kw)
        self.set_title("Pineapple Notes")
        ...
        self.list.set_css_classes(["pineapple-notes-list"])
        ...
        self.title_entry.set_css_classes(["pineapple-notes-title"])
        ...
        self.text_view.set_css_classes(["pineapple-notes-editor"])
    ...
    def _fallback_message(self, msg):
        print(f"[pineapple-notes] {msg}", flush=True)
