#!/usr/bin/env python3
# =============================================================================
#  Mak Photos — visualizador de fotos (pastas de imagens)
# =============================================================================
import os
...
APP_ID = "org.makos.photos"
IMAGE_EXTS = (".png", ".jpg", ".jpeg", ".gif", ".bmp", ".webp", ".svg", ".heic")


class MakPhotos(Gtk.Application):
    def __init__(self):
...
class PhotosWindow(Gtk.ApplicationWindow):
    def __init__(self, **kw):
        ...
        self.folder_label.add_css_class("mak-path")
        ...
        self.image.set_css_classes(["mak-photo-view"])
    ...
    def _show_current(self):
        ...
        try:
            ...
            self.set_title(f"Mak Photos — {self._images[self._index]}")
