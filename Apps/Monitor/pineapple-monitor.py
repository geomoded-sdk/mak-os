#!/usr/bin/env python3
# =============================================================================
#  Pineapple Monitor — monitor de recursos (CPU, RAM, disco, rede) + processos
# =============================================================================
import os
import signal
import time
...
APP_ID = "org.pineappleos.monitor"


class PineappleMonitor(Gtk.Application):
    def __init__(self):
...
class MonitorWindow(Gtk.ApplicationWindow):
    def __init__(self, **kw):
        super().__init__(**kw)
        self.set_title("Pineapple Monitor")
        ...
        vbox.append(self._row("CPU", self.cpu_bar, "pineapple-cpu"))
        vbox.append(self._row("Memória", self.mem_bar, "pineapple-mem"))
        ...
        self.chart.add_css_class("pineapple-chart")
        ...
        proc_title.add_css_class("pineapple-settings-subtitle")
    ...
    def _proc_row(self, pr):
        ...
        pid_lbl.add_css_class("pineapple-mono")
        cpu_lbl = Gtk.Label(label=f'{pr["cpu"]:5.1f}%', xalign=0.0)
        cpu_lbl.add_css_class("pineapple-mono")
        cpu_lbl.set_css_classes(["pineapple-mono", "pineapple-proc-cpu"])
        mem_lbl = Gtk.Label(label=f'{pr["rss"] / 1024.0:6.1f} MB', xalign=0.0)
        mem_lbl.add_css_class("pineapple-mono")
